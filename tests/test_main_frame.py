...
def main_frame() -> MainFrame:
    ...
    return MainFrame(ctk.CTkTabview(ctk.CTk()).add("A"), MainApp(), Simulation(Grid(), Screen(800, 600)))
...
def test_start_simulation(main_frame: MainFrame) -> None:
    ...
    main_frame.start_simulation(visual, progress_var, simulation_count, max_steps, graph_output_folder)
